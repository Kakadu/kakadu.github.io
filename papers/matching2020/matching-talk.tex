...
%\textsuperscript{1} JetBrains Research, Programming Languages and Tools Lab
...
\begin{forest} 
[$x$%, tikz={\draw[{Latex}-, thick] (.north) --++ (0,1);}
    [$y$
          [$z$
                [4] 
                [3] 
...
\begin{frame}[fragile]{Пример: Деревья и DAGи терма $f(g(a, x), g(a,x))$}
\begin{center}
