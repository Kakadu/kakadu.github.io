...
\begin{frame}[fragile]{Раскладка по регистрам и графы. Пример (1/2)}
\noindent{
\begin{minipage}{.5\textwidth}
\begin{figure}[h]
  \input{figures/liveness.tex}\par
...
\end{figure}
%Figure 2.16: (a) SSA-form program taken from Pereira and Palsberg [73]. (b)
%Program after the SSA elimination phase. (c) Interference graph and sequence
