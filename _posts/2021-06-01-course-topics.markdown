...
Можно делать как игрушечное веб-приложение, а можно интегрировать в VsCode.
...
- Type debugger для OCaml
  Визуальный отладчик проверки типов должен быть полезен новичкам. Уже есть [аналогичная поделка для Haskell](https://chameleon.typecheck.me/playground)
