...
* Front
    ...
    * Алгебраических типов пока совсем нет. Можно придумать общую тему на двух человек, где
      ...
      * другой --- generalized алгебраические типы и тайпчекер.
      Даже не знаю, какая из двух половин проще или сложнее. Наверное, это можно как-то скрестить с допуском по курсу ФП.
...
* Front+Back
    ...
    * массивы + автовекторизация
      ...
      Присваивание ни в каком виде сейчас нет.
...
* Добыть (например, в Стиме) и распаковать ресурсы для старой версии
