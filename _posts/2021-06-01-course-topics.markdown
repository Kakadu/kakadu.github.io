...
Требудется улучшить поддержку плагина Timelines для системы ведения заметок Obsidian. (Официальный плагин пожжерживается так себе. Экспериментировать надо с вот этим [форком](https://github.com/ReconVirus/obsidian-timelines))



Технологии: веб-браузер, typescript, npm.
