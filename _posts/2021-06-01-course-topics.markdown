...
Сейчас он кое-что умеет, но ему есть куда развиваться. Есть небольшое количество инфраструктурных задач (по типу интеграции с CI Github Actions), а также [большое количество](https://github.com/Kakadu/zanuda/issues/3) проверок ("линтов"), которые пока не реализованы. Мне нужно либо найти человека(-ов), который реализует больше линтов, либо реализовывать самому.
