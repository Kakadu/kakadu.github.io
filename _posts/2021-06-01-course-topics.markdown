...
Проект по open-source ремейку (уже не продающейся) игры "Космические рейнджеры 2: Доминаторы.Перезагрузка" давно заброшен, но при этом ещё [собирается](https://github.com/Kakadu/OpenSR), и если ему подсунуть ресурсы от уже не продаваемой версии.
Прототип написан на Qt/QML 5, работает под Linux (под остальным не пробовал).
Самой игры сейчас нет, только набросок движка. Реализовывать можно [в том порядке, в каком нравится](https://github.com/Kakadu/OpenSR/issues/1).
...
https://github.com/asmjit/asmjit/issues/430 RISC-V is missing
...
Можно написать всё на голых С++/OpenGL/Vulkan, или воспользоваться чем-то, сделалнным в библиотеке Qt3D.
